...
class Link(KeyBasedCompareMixin):
    ...
    def as_hashes(self) -> Optional[Hashes]:
        return self.link_hash.as_hashes() if self.link_hash is not None else None

    @property
    def hash(self) -> Optional[str]:
        return self.link_hash.value if self.link_hash is not None else None

    @property
    def hash_name(self) -> Optional[str]:
        return self.link_hash.name if self.link_hash is not None else None
